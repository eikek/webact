...
scriptIcons info =
    let
        success =
            Maybe.map .success info.output |> Maybe.withDefault True
    in
    [ i
        [ classList
            [ ( "large orange loading cog icon", True )
    ...
    , i
        [ classList
            [ ( "large disabled red ban icon", True )
    ...
    , i
        [ classList
            [ ( "large calendar check outline icon", True )
